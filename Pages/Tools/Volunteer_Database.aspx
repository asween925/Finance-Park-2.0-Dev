        ...
        <div class="content">
            ...
            <div id="divViewVolControls" runat="server" visible="false" style="border-bottom: 1px solid gray; padding-bottom: 10px;">
                ...
                <div id="divViewVolCtrlDGV" runat="server" visible="false">
                    <asp:GridView ID="dgvViewVolCtrl" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" CellPadding="5" Height="50" AllowPaging="True" ShowHeaderWhenEmpty="True" Font-Size="Medium" Visible="true" PageSize="20" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows">
                        <Columns>
            ...
            <div id="divViewVol" runat="server" visible="true">
                ...
                <div>
                    <asp:GridView ID="dgvVolunteers" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" DataKeyNames="ID" OnRowDataBound="dgvVolunteers_RowDataBound" OnRowEditing="dgvVolunteers_RowEditing" OnRowUpdating="dgvVolunteers_RowUpdating" OnRowCancelingEdit="dgvVolunteers_RowCancelingEdit" CellPadding="5" Height="50" AllowPaging="True" ShowHeaderWhenEmpty="True" Font-Size="Medium" Visible="true" PageSize="20" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows">
                        <Columns>
