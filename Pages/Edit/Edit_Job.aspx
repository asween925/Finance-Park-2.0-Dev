                ...
                <asp:GridView ID="jobs_dgv" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" DataKeyNames="ID" CellPadding="5" Height="50" AllowPaging="True" ShowHeaderWhenEmpty="True" Font-Size="Medium" OnRowEditing="jobs_dgv_RowEditing" OnRowCancelingEdit="jobs_dgv_RowCancelingEdit" OnRowUpdating="jobs_dgv_RowUpdating" OnRowDataBound="jobs_dgv_RowDataBound" OnPageIndexChanging="jobs_dgv_PageIndexChanging" OnRowDeleting="jobs_dgv_RowDeleting" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows"> 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Job Duties">
                            <ItemTemplate>
                                <asp:Textbox ID="jobDutiesDGV_tb" runat="server" CssClass="textbox" Text='<%#Bind("jobDuties") %>' TextMode="MultiLine" Height="70px" Width="200px" ></asp:Textbox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Educational <br /> Debt">
                            <ItemTemplate>
                                <asp:Textbox ID="edDebtDGV_tb" runat="server" Text='<%#Bind("edDebt") %>' CssClass="textbox" ></asp:Textbox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Advancement">
                            <ItemTemplate>
                                <asp:Textbox ID="advancementDGV_tb" runat="server" Text='<%#Bind("advancement") %>' CssClass="textbox" TextMode="MultiLine" Height="70px" Width="200px"></asp:Textbox>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
