    ...
    <form id="EMS_Form" runat="server">
        <div id="Site_Wrap_Fullscreen">
            ...
            <div id="login_div" runat="server" class="Sim_Login_Div">
                ...
                <p>First Name: <asp:TextBox ID="firstName_tb" runat="server" CssClass="textbox Sim_Login_Fields"></asp:TextBox></p>
                <p>Last Name: <asp:TextBox ID="lastName_tb" runat="server" CssClass="textbox Sim_Login_Fields"></asp:TextBox></p>
                ...
                <p>Teacher: <asp:TextBox ID="teacher_tb" runat="server" CssClass="textbox Sim_Login_Fields"></asp:TextBox></p>
                ...
                <p><asp:Button ID="login_btn" runat="server" CssClass="button Sim_Login_Fields" Text="Login" />&ensp;<asp:Button ID="reset_btn" runat="server" CssClass="buttonReset Sim_Login_Fields" Text="Reset" OnClick="reset_btn_Click" /></p>
            </div>        
