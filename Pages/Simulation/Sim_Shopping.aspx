    ...
    <form id="EMS_Form" runat="server">
            ...
            <div id="blur" class="blurArea">
                ...
                <div class="directionsBlock2">
                    <a class="directions">You may now go shopping. Select a business below and start your shopping!</a>&ensp;                   
                        <asp:Label ID="lblError" runat="server" CssClass="error_label" Text="test"></asp:Label>
        ...
        <div id="popup">
            <p class="popup_header">
                <asp:Label ID="lblPopupText" runat="server" Text="Please enter the Business ID to proceed:"></asp:Label>
            </p>
