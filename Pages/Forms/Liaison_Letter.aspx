...
<body>
    <form id="EMS_Form" runat="server">
        ...
        <div class="content">
            ...
            <asp:TextBox ID="tbVisitDate" runat="server" TextMode="Date" AutoPostBack="true" CssClass="textbox no-print" OnTextChanged="tbVisitDate_TextChanged"></asp:TextBox>&emsp;<asp:Label runat="server" ID="lblError" Font-Size="X-Large" ForeColor="Red" CssClass="no-print"></asp:Label>
            <p id="school_p" runat="server" visible="false" class="no-print">School Name:</p>
            <asp:DropDownList ID="ddlSchoolName" runat="server" AutoPostBack="true" Visible="false" CssClass="ddl no-print" OnSelectedIndexChanged="ddlSchoolName_SelectedIndexChanged"></asp:DropDownList>
            ...
            <div id="divLetter" runat="server" visible="false">
                ...
                <div id="divInfo" runat="server" visible="true">
                    ...
                    <br />
                    <p>School: <asp:Label ID="lblSchoolName" runat="server" Font-Bold="true"></asp:Label>&emsp; Liaison: <asp:Label ID="lblLiaison" runat="server" Font-Bold="true"></asp:Label></p>
                    <p>From: <a style="font-weight: bold;">Karen Brighton, Community Liaison, Stavros Institute</a></p>
                    <p>&nbsp;</p>
                    <p>Your school is scheduled to visit Finance Park on: <asp:Label ID="lblVisitDate" runat="server" Font-Bold="true"></asp:Label>.</p>
                    ...
                    <p>Volunteers should arrive at Finance Park by <asp:Label ID="lblArrivalTime" runat="server" Font-Bold="true"></asp:Label>. Dismissal will be at approximately <asp:Label ID="lblVolunteerDismissal" runat="server" Font-Bold="true"></asp:Label>.</p>
                    ...
                    <p>a complete list of all volunteers for each day should be sent to Karen Brighton by <asp:Label ID="lblReplyBy" runat="server" Font-Bold="true"></asp:Label>.</p>
            ...
            <asp:Image ID="imgFPLogo" runat="server" ImageUrl="../../Media/FP_SI_Logo.png" AlternateText="Finance Park Logo" ImageAlign="bottom" CssClass="FP_logo_print" Visible="true" />
        </div>
