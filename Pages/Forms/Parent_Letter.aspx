...
<div class="content">
    ...
    <asp:TextBox ID="tbVisitDate" runat="server" TextMode="Date" CssClass="textbox no-print" AutoPostBack="true" OnTextChanged="tbVisitDate_TextChanged"></asp:TextBox><a class="no-print">&ensp;</a><asp:Label ID="lblError" runat="server" Font-Bold="true" Font-Size="X-Large" ForeColor="Red"></asp:Label>
    ...
    <asp:Button ID="btnPrint" runat="server" Text="Save as PDF" CssClass="button no-print" OnClick="btnPrint_Click" />
    <br class="no-print" />
